...
void main() {
  ...
  testWidgets('.all throws readable error message', (widgetTester) async {
    ...
    expect(
      ...
      throwsSpotErrorContaining([
        "Expected that all candidates fulfill matcher 'property color equals <Color(0xff000000)>', but only 0 of 2 did.",
      ]),
    );
  });
  ...
  testWidgets('.any throws readable error message', (widgetTester) async {
    ...
    expect(
      ...
      throwsSpotErrorContaining([
        "Expected that at least one candidate fulfills matcher 'property color equals <Color(0xff000000)>', but none did.",
      ]),
    );
  });
}
