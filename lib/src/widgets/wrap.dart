...
extension WrapMatcher on WidgetMatcher<Wrap> {
  ...
  WidgetMatcher<Wrap> hasCrossAxisAlignment(WrapCrossAlignment value) {
    return hasProp<WrapCrossAlignment>(
        'crossAxisAlignment', (it) => it.equals(value));
  }
  ...
  WidgetMatcher<Wrap> hasVerticalDirection(VerticalDirection value) {
    return hasProp<VerticalDirection>(
        'verticalDirection', (it) => it.equals(value));
  }

  WidgetMatcher<Wrap> hasRenderObjectWhere(MatchProp<RenderObject> match) {
    return hasProp<RenderObject>('renderObject}', match);
  }

  WidgetMatcher<Wrap> hasRenderObject(RenderObject value) {
    return hasProp<RenderObject>('renderObject', (it) => it.equals(value));
  }
}
...
extension WrapSelector on WidgetSelector<Wrap> {
  ...
  WidgetSelector<Wrap> withRunAlignmentMatching(
      MatchProp<WrapAlignment> match) {
  ...
  WidgetSelector<Wrap> withCrossAxisAlignmentMatching(
      MatchProp<WrapCrossAlignment> match) {
  ...
  WidgetSelector<Wrap> withCrossAxisAlignment(WrapCrossAlignment value) {
    return withProp<WrapCrossAlignment>(
        'crossAxisAlignment', (it) => it.equals(value));
  }

  WidgetSelector<Wrap> withTextDirectionMatching(
  ...
  WidgetSelector<Wrap> withVerticalDirectionMatching(
      MatchProp<VerticalDirection> match) {
  ...
  WidgetSelector<Wrap> withVerticalDirection(VerticalDirection value) {
    return withProp<VerticalDirection>(
        'verticalDirection', (it) => it.equals(value));
  }

  WidgetSelector<Wrap> withRenderObjectMatching(MatchProp<RenderObject> match) {
    return withProp<RenderObject>('renderObject', match);
  }

  WidgetSelector<Wrap> withRenderObject(RenderObject value) {
    return withProp<RenderObject>('renderObject', (it) => it.equals(value));
  }
}
